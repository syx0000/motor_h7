...
unsigned char FDCAN1_RX_BUF[64] = {0};
unsigned char FDCAN1_RX_DATA[64] = {0};
unsigned char FDCAN1_TxData[8] = {0x12, 0x34, 0x56, 0x78, 0xAA, 0xBB, 0xCC, 0xDD};
/* USER CODE END 0 */
...
void MX_FDCAN1_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN1_Init 2 */
	...
	sFilterConfig.FilterType = FDCAN_FILTER_MASK;//滤波器类型：掩码模式
	sFilterConfig.FilterConfig = FDCAN_FILTER_TO_RXFIFO0;//过滤器0关联到FIFO0
	sFilterConfig.FilterID1 = 0x0000; // 掩码全0，接收所有ID
	sFilterConfig.FilterID2 = 0x0000; // 掩码全0，接收所有ID
